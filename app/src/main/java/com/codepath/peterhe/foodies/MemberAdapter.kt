...
class MemberAdapter(val context: Context, val members: MutableList<ParseUser>) :
    ...
    inner class ViewHolder(itemView: View, listner: MemberAdapter.onItemClickListner) :
